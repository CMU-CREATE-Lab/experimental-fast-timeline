...
concat:
	...
	TileLoader.js TileView.js DataStoreTile.js CanvasTile.js DataStoreTileLayer.js Shaders.js \
	TouchUtils.js Plot.js SeriesPlotContainer.js Grapher.js TileConstants.js TimeConstants.js Uuid.js > ${CONCAT_PATH}
